...
export async function GET() {
    try {
        ...
        // Removed "Selected" as it caused a JQL error (status not found in project)
        const statusExclusions = '"Done", "Closed", "Resolved", "Готово", "Отменено", "Backlog", "To Do", "К выполнению"';
        ...
        // Using specific Team field ID (10001) and Team UUID provided by user
        // JQL: project = DEV AND assignee IS empty AND "cf[10001]" = c6bf7c58-d853-474d-bbe6-ebe40bf41eb4
        // Removed quotes around UUID to match user's working link exactly
        const unassignedJql = 'project = DEV AND assignee IS empty AND "cf[10001]" = c6bf7c58-d853-474d-bbe6-ebe40bf41eb4';
