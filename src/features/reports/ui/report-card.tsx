...
import { ReportType, ReportFilters } from '../model/report-types';
import { ProgressBar } from './progress-bar';
import { ReportFiltersModal } from './report-filters-modal';
...
export function ReportCard({ report }: ReportCardProps) {
    ...
    async function handleGenerate(filters: ReportFilters) {
